            ...
            <div className='watchCointainer'>
                <Grid
                    ...
                    <Grid 
                      ...
                      style={{
                        fontSize:13, 
                        color:isTimerView?'#1a73e8':isMouseHoverOnTimer?'#000':'#6b6a6a',
                        fontWeight:300,
                        padding:14, 
                    ...
                    >
                      <div>
                        <HourglassEmptyIcon  style={{fontSize:13, marginBottom:-2,paddingRight:5}}/>
                        {`timer`.toUpperCase()}
                      </div>
                    </Grid>
                    {/* stopwatch */}
                    <Grid
                        ...
                        style={{
                          fontSize:13, 
                          color:isStopwatchView?'#1a73e8':isMouseHoverOnStopwatch?'#000':'#6b6a6a',
                          fontWeight:300,
                          padding:14, 
                    ...
                    >
                          <TimerIcon style={{fontSize:13, marginBottom:-2,paddingRight:5}}/>
                          {`stopwatch`.toUpperCase()}</Grid>
                </Grid>
                {/* footer */}
                <Grid
